            ...
            <div className='px-32'>
                ...
                <div className='flex gap-24'>
                    <div className='flex flex-col text-center gap-2'>
                        <div className='w-44 h-56 bg-orange-100 shadow-3xl mb-4'></div>
                        <p className='text-brown-200 font-thin'>Name of the book</p>
                        <p className='text-brown-200 font-thin'>Author</p>
                        <p className='text-brown-200 font-thin'>Rating</p>
                    </div>
                    <div className='flex flex-col text-center gap-2'>
                        <div className='w-44 h-56 bg-orange-100 shadow-3xl mb-4'></div>
                        <p className='text-brown-200 font-thin'>Name of the book</p>
