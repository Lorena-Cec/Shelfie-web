      ...
      <div className="flex flex-col items-center align-middle">
        <div className="flex flex-col gap-3 items-start mt-20 mb-5 w-0.3">
            ...
            <p className='text-brown-200 font-thin'>
                Which genres make you feel excited? Tell us what you like and we will adjust your recommendations based on what you select.
            </p>
        </div>
        ...
        <form onSubmit={sendInfo} className="space-y-3 w-0.3 bg-white border border-orange-400 rounded-lg mb-10">
            <div className='flex flex-col px-10 py-5 items-center'>
                ...
                <p className='text-brown-300 mb-5 mt-5'>What genres do you like to read?</p>
                  ...
                  <div className="bg-white border border-gray-300 mt-1 w-full z-10 flex flex-wrap justify-between gap-2">
                      ...
                      <div 
                        ...
                        className={`flex items-center p-2 cursor-pointer rounded-lg ${
                          genres.includes(genre) ? 'bg-orange-200' : 'hover:bg-orange-400'
                        }`}
                      >
                        <p className={`text-brown-100 whitespace-nowrap ${genres.includes(genre) ? 'text-white' : ''}`}>
                          {genre}
                        </p>
                      </div>
                      ))}
                ...
                <button type="submit" className="w-full bg-orange-100 text-white py-2 rounded-md hover:bg-orange-200">
                    Save Genres
                </button> 
            </div>
        </form>
