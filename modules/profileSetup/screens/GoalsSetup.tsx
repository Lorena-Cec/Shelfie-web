  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-col items-center bg-orange-700">
        ...
        <form onSubmit={sendInfo} className="space-y-3 w-0.3 bg-white border border-orange-400 rounded-lg mb-20">
            ...
            <div className='flex flex-col px-10 py-5 items-center '>
              <div className="w-fit">
                <p className='text-brown-200  font-bold'>How many books do you want to read this year?</p>
                ...
                <div className='w-full '>
                  ...
                  /> 
                  <p className='text-brown-300 text-center mt-4'>You will read <span className='font-bold'>{booksToRead}</span> books this year!</p>              
                </div> 
              ...
              <div className="w-fit">
                <p className='text-brown-200 mt-10 font-bold'>What other reading goals do you want to set for this year?</p>
                <div className='w-full h-0.5 bg-brown-400 mb-5'></div>
              </div>
              <div className='w-full mb-5'>
                <div className="bg-white w-full z-10">
                    {allgoals.map((goal) => (
                    <div key={goal} className="w-full flex items-center p-2 border-2 border-orange-600 mt-1">
                        <input 
                        type="checkbox" 
